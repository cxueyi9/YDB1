...
- (void)updateInfoLabel:(UILabel *)label;   // 声明
@end
...
- (void)showEditPanel {
    ...
    resetBtn.backgroundColor = [UIColor colorWithRed:0.9 green:0.3 blue:0.3 alpha:0.15];
    ...
    infoLabel.tag = 4000;
    [self updateInfoLabel:infoLabel];   // 现在已实现
